...
import type {
  ...
  FilesGetDownloadUrlData,
  FilesGetDownloadUrlResponse,
  FilesGetFileInfoData,
  FilesGetFileInfoResponse,
  FilesHealthCheckResponse,
  FilesListFilesData,
...
export class FilesService {
  ...
  public static listFiles(
    data: FilesListFilesData = {},
  ): CancelablePromise<FilesListFilesResponse> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/api/v1/files/",
      query: {
  ...
  public static getFileInfo(
    data: FilesGetFileInfoData,
  ): CancelablePromise<FilesGetFileInfoResponse> {
    return __request(OpenAPI, {
      method: "GET",
  ...
  public static deleteFile(
    data: FilesDeleteFileData,
  ): CancelablePromise<FilesDeleteFileResponse> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/api/v1/files/{file_id}",
      path: {
  ...
  public static getDownloadUrl(
    data: FilesGetDownloadUrlData,
  ): CancelablePromise<FilesGetDownloadUrlResponse> {
    return __request(OpenAPI, {
      method: "GET",
